...
public final class ECKMarketOrder: Decodable, Identifiable, Sendable {
    ...
    public static let dummy1: ECKMarketOrder = .init(duration: 30,
                                                     escrow: nil,
                                                     isBuyOrder: false,
                                                     isCorporation: false,
    ...
    public static let dummy2: ECKMarketOrder = .init(duration: 30,
                                                     escrow: nil,
                                                     isBuyOrder: true,
                                                     isCorporation: false,
    ...
    public required init(from decoder: any Decoder) throws {
        ...
        self.isCorporation = try container.decodeIfPresent(Bool.self, forKey: .isCorporation) ?? true
        ...
        self.walletDivision = try container.decodeIfPresent(Int.self, forKey: .walletDivision)
    }
